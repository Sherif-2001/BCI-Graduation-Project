...
class Ui_PatientsMainWindow(object):
    def setupUi(self, PatientsMainWindow):
        ...
        PatientsMainWindow.setStyleSheet(
    ...
    def retranslateUi(self, PatientsMainWindow):
        ...
        self.label_24.setText(_translate("PatientsMainWindow", "Affacted Hand:"))
        ...
        self.label_26.setText(_translate("PatientsMainWindow", "Affacted Hand"))
        ...
        self.label_14.setText(_translate("PatientsMainWindow", "Adress"))
        self.label_19.setText(_translate("PatientsMainWindow", "Height:"))
        self.label_13.setText(_translate("PatientsMainWindow", "Adress:"))
