...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        # Add top spacer
        self.gridLayout.addItem(QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding), 0, 1)
        
        # Create main widget for grasp/release label
        ...
        self.grasp_release_label_6.setMinimumSize(QtCore.QSize(400, 150))  # Increase the minimum size
        self.grasp_release_label_6.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        self.horizontalLayout_6.addWidget(self.grasp_release_label_6)
        
        # Add right spacer
        self.horizontalLayout_6.addItem(QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum))
        
        # Add grasp/release label widget to grid
        self.gridLayout.addWidget(self.widget, 1, 1, 1, 1)
        
        # Add bottom spacer
        self.gridLayout.addItem(QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding), 2, 1)
        
        # Add left spacer to grid
        self.gridLayout.addItem(QtWidgets.QSpacerItem(130, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum), 3, 0)
        ...
        self.photo_widget.setMinimumSize(QtCore.QSize(200, 150))  # Set minimum size
        self.photo_widget.setMaximumSize(QtCore.QSize(400, 300))  # Set maximum size
        ...
        # Add photo widget to grid
        self.gridLayout.addWidget(self.photo_widget, 3, 1, 1, 1)
        
        # Add right spacer to grid
        self.gridLayout.addItem(QtWidgets.QSpacerItem(130, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum), 3, 2)
        
        # Add bottom spacer to grid
        self.gridLayout.addItem(QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding), 4, 1)
