...
"")
        ...
        # self.grasp_release_label_6.setMaximumSize(QtCore.QSize(300, 100)) # Increase the minimum size
        ...
        self.photo_widget.setMinimumSize(QtCore.QSize(150, 150))  # Decrease the minimum size
        # self.photo_widget.setMaximumSize(QtCore.QSize(300, 300))  # Decrease the minimum size
